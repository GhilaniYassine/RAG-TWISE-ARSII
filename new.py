...
st.title("🧠 NeuroGuide AI (RAG-Powered Medical Assistant) 🔍")
st.markdown("""
### Your Trusted Companion for Understanding Alzheimer's and Parkinson's Diseases

This intelligent system is designed to help patients, caregivers, and medical professionals access and understand 
information about Alzheimer's and Parkinson's diseases. Using advanced RAG (Retrieval-Augmented Generation) technology, 
we provide accurate, research-based answers to your questions about these conditions.
""")
...
# Chatbot Page
    ...
    try:
        ...
        st.info("Please contact support at ghilaniyassine11@gmail.com")
...
# Contact Page
    ...
    - **Email:** (mailto:ghilaniyassine11@gmail.com) ✉️
    - **GitHub:** [Contribute on GitHub](https://github.com/GhilaniYassine/Document-Buddy-App) 🐺
...
# Footer
st.markdown("---")
st.markdown("© 2024 RAG-Medical Assistant by Yassine Ghilani's Timberwolves Team | Empowering understanding of neurodegenerative diseases 🧠")
